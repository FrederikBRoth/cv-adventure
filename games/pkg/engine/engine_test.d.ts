...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h8f62c2c437e04d13: (a: number, b: number) => void;
  readonly closure836_externref_shim: (a: number, b: number, c: any, d: any) => void;
