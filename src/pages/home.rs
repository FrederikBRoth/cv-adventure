    ...
    view! {
        <div id="main" class="grid grid-cols-12 w-full grid-rows-300 h-2000">
            ...
            <div class="col-start-2 col-end-12 bg-pink-500 rounded-xl opacity-75 md:col-end-9 z-2 row-start-38 row-end-62">
                <Carousel>
                    <CarouselElement>Thing here!</CarouselElement>
                    <CarouselElement>Another thing here!</CarouselElement>
                    <CarouselElement>Yet another thing here!</CarouselElement>
                </Carousel>
            </div>

            // Rust info
            <div class="col-start-2 col-end-12 bg-pink-500 rounded-xl opacity-75 md:col-start-5 z-2 row-start-70 row-end-94">
            </div>

            // C++ info
            <div class="col-start-2 col-end-12 bg-pink-500 rounded-xl opacity-75 md:col-end-9 z-2 row-start-102 row-end-126">
            </div>

            // Containerization/Devops info
            <div class="col-start-2 col-end-12 bg-pink-500 rounded-xl opacity-75 md:col-start-5 z-2 row-start-134 row-end-159">
            </div>

            // Whatever
            <div class="col-start-2 col-end-12 bg-pink-500 rounded-xl opacity-75 md:col-end-5 z-2 row-start-167 row-end-179 md:row-end-192">
            </div>
            ...
            // whatever 3
            <div class="col-start-2 col-end-12 bg-pink-500 rounded-xl opacity-75 md:col-end-9 z-2 row-start-200 row-end-225">
            </div>

            // whatevr 4
            <div class="col-start-2 col-end-12 bg-pink-500 rounded-xl opacity-75 md:col-start-5 z-2 row-start-233 row-end-258">
            </div>
            // Whatever
            <div class="col-start-2 col-end-12 bg-pink-500 rounded-xl opacity-75 md:col-end-5 z-2 row-start-266 row-end-278 md:row-end-291">
            </div>
